...
{
    PAGED_CODE();
    DbgPrint(TRACE_INFORMATION, "--> Mali G610 Render only display driver");
    ...
    InitialData.DxgkDdiStartDevice = G610StartDevice;
    ...
    InitialData.DxgkDdiGetScanLine = G610DdiGetScanLine;
    ...
    DbgPrint(TRACE_INFORMATION, "<-- DriverEntry exit\n");
    return Status;
}